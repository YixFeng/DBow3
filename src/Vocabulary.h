...
public:
  ...
  //io to-from a stream
  void toStream(  std::ostream &str, bool compressed=true) const noexcept;
  void fromStream(  std::istream &str )   noexcept;
...
protected:
   ...
   */
    ...
    */
   void load_fromtxt(const std::string &filename)noexcept;
