...
void Vocabulary::toStream(  std::ostream &out_str, bool compressed) const noexcept{
...
void Vocabulary:: load_fromtxt(const std::string &filename) noexcept{
...
void Vocabulary::fromStream(  std::istream &str )   noexcept{
